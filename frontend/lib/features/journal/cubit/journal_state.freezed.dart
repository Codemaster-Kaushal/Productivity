...
mixin _$JournalState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<JournalEntry> entries) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<JournalEntry> entries)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<JournalEntry> entries) : _entries = entries;
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, DeepCollectionEquality().hash(_entries));
...
abstract class _Loaded implements JournalState {
  const factory _Loaded(final List<JournalEntry> entries) = _$LoadedImpl;
